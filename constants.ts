...
// These arrays define the structure and icons for cards, which are static.
// The text content itself is managed via the CMS.

export const PROPERTY_INFO_CARDS_STRUCTURE = [
  { id: 'card1', icon: React.createElement(HomeIcon, { className: "w-8 h-8 text-teal-600" }) },
  { id: 'card2', icon: React.createElement(UsersIcon, { className: "w-8 h-8 text-teal-600" }) },
  { id: 'card3', icon: React.createElement(BedDoubleIcon, { className: "w-8 h-8 text-teal-600" }) },
  { id: 'card4', icon: React.createElement(SoupIcon, { className: "w-8 h-8 text-teal-600" }) },
  { id: 'card5', icon: React.createElement(BathIcon, { className: "w-8 h-8 text-teal-600" }) },
  { id: 'card6', icon: React.createElement(WavesIcon, { className: "w-8 h-8 text-teal-600" }) },
];

export const SERVICES_LIST_STRUCTURE = [
    { id: 'service1', icon: React.createElement(WifiIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
    { id: 'service2', icon: React.createElement(CarIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
    { id: 'service3', icon: React.createElement(SunIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
    { id: 'service4', icon: React.createElement(SnowflakeIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
    { id: 'service5', icon: React.createElement(WavesIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
    { id: 'service6', icon: React.createElement(WashingMachineIcon, { className: "w-10 h-10 mx-auto text-teal-600" }) },
];
